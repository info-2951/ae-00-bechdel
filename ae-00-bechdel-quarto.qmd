---
title: "AE 00: Visualizing the Bechdel test"
author: Your name
format: html
---

::: callout-important
Go to [`ae-00-bechdel`](https://github.com/info-2951/ae-00-bechdel) and clone the repo in RStudio to get started.
...
- This assignment is derived from [Data Science in a Box](https://datasciencebox.org/course-materials/application-exercises/ae-02-bechdel-rmarkdown/bechdel.html) and licensed under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
